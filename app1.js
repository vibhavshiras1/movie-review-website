...
app.post('/',function(req,res){
    ...
    if(username1==undefined && password1==undefined){
        ...
        res.send("<h1>You have successfully signed up!!</h1></br><h2>You'll have to go back and login.</h2>");
    }
...
app.post('/home/horror',function(req,res){
    res.render('horror');
})

app.post('/home/comedy',function(req,res){
    res.render('comedy');
})
...
app.get('/home/action/bloodshot',function(req,res){
    res.render('bloodshot');
})

app.get('/home/action/hobbsandshaw',function(req,res){
    res.render('hobbsandshaw');
})

app.get('/home/action/justiceleague',function(req,res){
    res.render('justiceleague');
})

app.get('/home/action/kingsman',function(req,res){
    res.render('kingsman');
})

app.get('/home/drama/joker',function(req,res){
    res.render('joker');
})

app.get('/home/drama/1917',function(req,res){
    res.render('1917');
})

app.get('/home/drama/astarisborn',function(req,res){
    res.render('astarisborn');
})

app.get('/home/drama/gravity',function(req,res){
    res.render('gravity');
})

app.get('/home/drama/titanic',function(req,res){
    res.render('titanic');
})
